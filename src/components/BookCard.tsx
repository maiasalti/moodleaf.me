...
export default function BookCard({ book, index, saved, isRead, onToggleSave, onToggleRead, onClick }: BookCardProps) {
    ...
    >
      <div className="relative aspect-[2/3] w-full overflow-hidden bg-stone-100">
        ...
        {onToggleRead && (
          ...
          >
            {isRead ? (
              <svg className="h-4 w-4 text-green-700" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
