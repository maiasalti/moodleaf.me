  ...
  return (
    <div ref={ref} className="relative inline-block">
      <button
        ...
        className="flex items-center gap-2 rounded-lg border border-stone-200 bg-white/60 px-4 py-2 text-sm text-stone-600 backdrop-blur-sm transition-colors hover:border-stone-300 hover:bg-white/80"
      >
        <span>{label}</span>
        <svg
      ...
      {open && (
        <div className="absolute left-0 z-20 mt-2 w-56 rounded-xl border border-stone-200 bg-white/95 p-2 shadow-lg backdrop-blur-md">
          {selected.size > 0 && (
            <button
              onClick={clearAll}
